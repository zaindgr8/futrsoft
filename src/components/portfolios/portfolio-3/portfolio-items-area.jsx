...
import portfolio_data_three from "./portfolio-data-three";
...
const categories = [
    "All",
    ...new Set(portfolio_data_three.map((item) => item.category)),
  ];
        ...
        <>
         ...
         <div className="container">
            ...
            {items.map((item, i) => (
              <div
                key={i}
                className={`col-6 col-xl-4 tp-portfolio-item mb-25 w-img ${item.cls}`}
              >
